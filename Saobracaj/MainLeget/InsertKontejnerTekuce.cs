...
namespace Saobracaj.MainLeget
{
    internal class InsertKontejnerTekuce
    {
        ...
        public void UpdKontejnerTerkuce(string Kontejner, int Skladiste, int Pozicija, int Kvalitet, int TipKontejnera, double Kolicina)
        {

            SqlConnection myConnection = new SqlConnection(connect);
            SqlCommand myCommand = myConnection.CreateCommand();
            myCommand.CommandText = "UpdateKontejnerTekuce";
            myCommand.CommandType = System.Data.CommandType.StoredProcedure;
