...
{
    public partial class frmStatusUsluge : Syncfusion.Windows.Forms.Office2010Form
    {
        bool status = false;
        public frmStatusUsluge()
        {
            InitializeComponent();
        }
        ...
        private void frmStatusUsluge_Load(object sender, EventArgs e)
        {
            RefreshDataGrid();
        }
