...
{
    public partial class frmStatusVozila: Form
    {
        bool status = false;
        ...
        private void frmStatusVozila_Load(object sender, EventArgs e)
        {
            RefreshDataGrid();
        }
        ...
        private void tsDelete_Click(object sender, EventArgs e)
        {
            ...
            del.DelStatusUsluga(Convert.ToInt32(txtSifra.Text.TrimEnd()));
