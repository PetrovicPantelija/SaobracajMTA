...
{
    class InsertVrstaVozila
    {
        public int InsVrstaVozila(string Naziv)
        {
            int IDPom = 0;
            var s_connection = Saobracaj.Sifarnici.frmLogovanje.connectionString;
            SqlConnection myConnection = new SqlConnection(s_connection);
            SqlCommand myCommand = myConnection.CreateCommand();
            myCommand.CommandText = "InsertVrstaVozila";
            myCommand.CommandType = System.Data.CommandType.StoredProcedure;

            SqlParameter naziv = new SqlParameter();
            naziv.ParameterName = "@Naziv";
            naziv.SqlDbType = SqlDbType.Char;
            naziv.Size = 35;
        ...
        public void UpdVrstaVozila(int ID, string Naziv)
        {
            var s_connection = Saobracaj.Sifarnici.frmLogovanje.connectionString;
            SqlConnection myConnection = new SqlConnection(s_connection);
            SqlCommand myCommand = myConnection.CreateCommand();
            myCommand.CommandText = "UpdateVrstaVozila";
            myCommand.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public void DelVrstaUsluga(int ID)
        {
            var s_connection = Saobracaj.Sifarnici.frmLogovanje.connectionString;
            SqlConnection myConnection = new SqlConnection(s_connection);
            SqlCommand myCommand = myConnection.CreateCommand();
            myCommand.CommandText = "DeleteVrstaVozila";
            myCommand.CommandType = System.Data.CommandType.StoredProcedure;
