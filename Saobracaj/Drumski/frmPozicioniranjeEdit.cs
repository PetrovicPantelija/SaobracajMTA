...
{
    public partial class frmPozicioniranjeEdit: Form
    {
        public event Action<int> SnimanjeZavrseno;
        bool status = false;
        int id = 0;
        string napomena = "";
        public frmPozicioniranjeEdit()
        {
            InitializeComponent();
            ChangeTextBox();
            status = true;
        ...
        public frmPozicioniranjeEdit(int Id, string Napomena)
        {
            id = Id;
            napomena = Napomena;
            InitializeComponent();
        ...
        private void button21_Click(object sender, EventArgs e)
        {
            ...
            if (status == true)
            {
                noviID = ins.InsNapomena(napomena);
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            ...
            int sifraID;
            if (!string.IsNullOrWhiteSpace(txtID.Text) && int.TryParse(txtID.Text, out sifraID))
            {
