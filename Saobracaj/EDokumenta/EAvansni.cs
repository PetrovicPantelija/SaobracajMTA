...
{
    public partial class EAvansni : Form
    {
        ...
        {
            var query = "Select FaStFak as [BR] From Faktura Where FaStatus='PO' and FaVrstDok='AV' order by FaStFak desc";
        ...
        private void CreateXML()
        {
            ...
            using (XmlWriter xw = XmlWriter.Create(filename, xws))
            {
                el.Add(
                    ...
                    new XElement(cbc + Const.OznakaDok, "386"),
                    new XElement(cbc + Const.Napomena, (napomena1 + "\n" + napomena2).ToString().Trim()),
                    new XElement(cbc + Const.Valuta, valuta),
                    ino_tax,
                    new XElement(cbc + "BuyerReference", faktura.ToString()),
                    new XElement(cac + Const.PeriodObaveze,
                    new XElement(cbc + Const.DescriptionCode, "432")),
                    ...
                    //new XElement(cac + Const.Identification,
                    //new XElement(cbc + Const.ID, "9948:" + Const.PIB_KP)),
                    new XElement(cac + Const.PartyName,
