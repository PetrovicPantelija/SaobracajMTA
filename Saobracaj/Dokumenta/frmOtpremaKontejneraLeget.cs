...
{
    public partial class frmOtpremaKontejneraLeget : Form
    {
        ...
        int usao = 0;
        public frmOtpremaKontejneraLeget()
        {
            InitializeComponent();
        }

        public frmOtpremaKontejneraLeget(string Korisnik)
        {
            InitializeComponent();
            KorisnikCene = Korisnik;
        }

        public frmOtpremaKontejneraLeget(string Korisnik, int Vozom)
        {
            InitializeComponent();
        ...
        public frmOtpremaKontejneraLeget(int sifra, string Korisnik)
        {
            InitializeComponent();
            KorisnikCene = Korisnik;
