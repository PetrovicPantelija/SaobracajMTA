...
namespace Saobracaj.Dokumenta
{
    public partial class frmPrijemKontejneraKamionLegetUvoz :  Form
    {
       MailMessage mailMessage;
        ...
        private void ChangeTextBoxPanel7()
        {
     ...
     " where BrojKontejnera = '" + BrojKontejnera.Trim() + "' order by id desc ", con);
        ...
        private void UbaciPodatkeOKontejneru()
        {
            ...
            ins.UpdUvoz(Convert.ToInt32(txtKontejnerID.Text), Convert.ToDateTime(DateTime.Now),
                ...
                "",0, Convert.ToDecimal(txtTaraTerminal.Value), 0,0,0,0,0,0,0,0, Convert.ToDateTime(DateTime.Now), 0, Convert.ToDateTime(DateTime.Now), 0, Convert.ToDateTime(DateTime.Now), 0, 0, Convert.ToDateTime(DateTime.Now), Convert.ToDateTime(DateTime.Now),0);
