...
namespace Saobracaj.Dokumenta
{
    class InsertRadniNalog
    {
        ...
        public void InsRadniNalogIzNajaveKopiranjem(int IDRadnogNalogaPostojeci, int IDNajaveNovi, string OznakaPoslaNovi)
        {
            ...
            SqlParameter parameter = new SqlParameter();
            parameter.ParameterName = "@IDRadnogNalogaPostojeci";
            parameter.SqlDbType = SqlDbType.Int;
            parameter.Direction = ParameterDirection.Input;
            parameter.Value = IDRadnogNalogaPostojeci;
            myCommand.Parameters.Add(parameter);

            SqlParameter parameter2 = new SqlParameter();
            parameter2.ParameterName = "@IDNajaveNovi";
            parameter2.SqlDbType = SqlDbType.Int;
            parameter2.Direction = ParameterDirection.Input;
            parameter2.Value = IDNajaveNovi;
            myCommand.Parameters.Add(parameter2);

            SqlParameter parameter3 = new SqlParameter();
            parameter3.ParameterName = "@OznakaPoslaNovi";
            parameter3.SqlDbType = SqlDbType.NVarChar;
            parameter3.Size = 30;
            parameter3.Direction = ParameterDirection.Input;
            parameter3.Value = OznakaPoslaNovi;
            myCommand.Parameters.Add(parameter3);
