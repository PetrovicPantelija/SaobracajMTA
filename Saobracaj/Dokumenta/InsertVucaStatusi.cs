...
{
    class InsertVucaStatusi
    {
        public string connect = ConfigurationManager.ConnectionStrings["WindowsFormsApplication1.Properties.Settings.NedraConnectionString"].ConnectionString;
        public void InsVucaStatusi(string Naziv)
        {
            SqlConnection conn = new SqlConnection(connect);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "InsertSifVucaStatusi";
        ...
        public void UpdateVucaStatusi(int ID, string Naziv)
        {
            SqlConnection conn = new SqlConnection(connect);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "UpdateSifVucaStatusi";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DeleteVucaStatusi(int ID)
        {
            SqlConnection conn = new SqlConnection(connect);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "DeleteSifVucaStatusi";
            cmd.CommandType = CommandType.StoredProcedure;
