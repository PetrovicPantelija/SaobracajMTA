...
{
    public partial class frmDokumentaIzvozManipulacije : Form
    {
        bool status = true;
        public frmDokumentaIzvozManipulacije()
        {
            InitializeComponent();
        }

        public frmDokumentaIzvozManipulacije(string SifraUsluge)
        {
            InitializeComponent();
        ...
        private void RefreshDataGrid()
        {
            ...
            var select = "select * from [DokumentaIzvozKonacnaUsluga]  where [IDIzvozKonacnaUsluga] =  " + txtSifraUsluge.Text;
        ...
        private void KopirajFajlPoTipu(string putanja, string FolderDestinacije, int Tip)
        {
             ...
             * */
            string configvalue1 = ConfigurationManager.AppSettings["ip"];
            targetPath = @"\\192.168.99.10\Leget\IzvozUslugeSlike\" + FolderDestinacije;
            // }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (status == true)
            {
                ...
                ins.InsIzvozUslugaDokumenta(Convert.ToInt32(txtSifraUsluge.Text), txtPutanja.Text);
                RefreshDataGrid();
                status = true;
            }
            else
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                del.DelIzvozUslugaDokumenta(Convert.ToInt32(txtSifra.Text));
                RefreshDataGrid();
            }
