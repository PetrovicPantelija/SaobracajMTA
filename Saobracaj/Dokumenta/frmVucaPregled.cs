...
namespace Saobracaj.Dokumenta
{
    public partial class frmVucaPregled : Form
    {
        ...
        private void FillGV()
        {
            ...
            var select = " SELECT     Vuca.ID, SifVucaStatusi.Naziv, VucaStatusi.Vreme, VucaStatusi.Napomena as NapomenaVucaStatus, Stanice.OPis as StanicaStatus,   Vuca.StavkaAktivnostiID, Vuca.VrstaPosla, Vuca.VrstaPrimopredaje, Vuca.Kilometraza, Vuca.MotoSati, Vuca.NivoGoriva, Vuca.Napomena, Vuca.Lokomotiva, " + 
            " Vuca.Dizel, AktivnostiStavke.VrstaAktivnostiID, AktivnostiStavke.Sati, AktivnostiStavke.Posao, AktivnostiStavke.OznakaPosla, AktivnostiStavke.DatumZavrsetka, " +
