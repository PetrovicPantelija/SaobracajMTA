...
{
    public partial class frmTipPalete : Form
    {
        public static string code = "frmTipPalete";
        public bool Pravo;
        int idGrupe;
        int idForme;
        bool insert;
        ...
        public frmTipPalete(string Korisnik)
        {
            InitializeComponent();
        ...
        private void tsSave_Click(object sender, EventArgs e)
        {
            if (status == true)
            {
                ...
                ins.InsTipPalete(txtNaziv.Text, Convert.ToDateTime(DateTime.Now), Kor);
                status = false;
            }
            else
            {
        ...
        private void tsDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                InsertTipPalete upd = new InsertTipPalete();
                upd.DeleteTipPalete(Convert.ToInt32(txtSifra.Text));
                RefreshDataGrid();
            }
        ...
        {
            var select = " SELECT [ID] ,Naziv,[Datum],[Korisnik] FROM [dbo].[TipPalete]";
        ...
        private void frmTipPalete_Load(object sender, EventArgs e)
        {
            RefreshDataGrid();
        }
    }
