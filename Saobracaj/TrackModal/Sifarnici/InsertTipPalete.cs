...
{
    internal class InsertTipPalete
    {
        public void InsTipPalete(string Naziv, DateTime Datum, string Korisnik)
        {

            var s_connection = Saobracaj.Sifarnici.frmLogovanje.connectionString;
            SqlConnection myConnection = new SqlConnection(s_connection);
            SqlCommand myCommand = myConnection.CreateCommand();
            myCommand.CommandText = "InsertTipPalete";
        ...
        public void UpdTipPalete(int ID, string Naziv, DateTime Datum, string Korisnik)
        {

            var s_connection = Saobracaj.Sifarnici.frmLogovanje.connectionString;
            SqlConnection myConnection = new SqlConnection(s_connection);
            SqlCommand myCommand = myConnection.CreateCommand();
            myCommand.CommandText = "UpdateTipPalete";
            myCommand.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public void DeleteTipPalete(int ID)
        {
            var s_connection = Saobracaj.Sifarnici.frmLogovanje.connectionString;
            SqlConnection myConnection = new SqlConnection(s_connection);
            SqlCommand myCommand = myConnection.CreateCommand();
            myCommand.CommandText = "DeleteTipPalete";
            myCommand.CommandType = System.Data.CommandType.StoredProcedure;
