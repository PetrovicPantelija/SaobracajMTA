...
namespace Saobracaj.TrackModal.Sifarnici
{
    public partial class frmGrupaVrsteManipulacije : Syncfusion.Windows.Forms.Office2010Form
    {
        ...
        bool status = false;
        public static string code = "frmGrupaVrsteManipulacije";
        public bool Pravo;
        int idGrupe;
        int idForme;
        bool insert;
        ...
        string niz = "";
        public frmGrupaVrsteManipulacije()
        {
            InitializeComponent();
        ...
        private void tsSave_Click(object sender, EventArgs e)
        {
            if (status == true)
            {
                ...
                ins.InsGrupaVrsteManipulacije(txtNaziv.Text, Convert.ToDateTime(DateTime.Now), KorisnikCene);
                status = false;
            }
            else
            {
                //int TipCenovnika ,int Komitent, double Cena , int VrstaManipulacije ,DateTime  Datum , string Korisnik
                InsertGrupaVrsteManipulacije upd = new InsertGrupaVrsteManipulacije();
                upd.UpdGrupaVrsteManipulacije(Convert.ToInt32(txtSifra.Text), txtNaziv.Text, Convert.ToDateTime(DateTime.Now), KorisnikCene);
            }
            RefreshDataGrid();
        }
        ...
        private void tsDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                InsertGrupaVrsteManipulacije upd = new InsertGrupaVrsteManipulacije();
                upd.DeleteGrupaVrsteManipulacije(Convert.ToInt32(txtSifra.Text));
                RefreshDataGrid();
            }
        ...
        {
            var select = " SELECT [ID] ,Naziv,[Datum],[Korisnik] FROM [dbo].[GrupaVrsteManipulacije] order by ID";
        ...
        private void VratiPodatke(string ID)
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT ID , Naziv from GrupaVrsteManipulacije where ID=" + txtSifra.Text, con);
