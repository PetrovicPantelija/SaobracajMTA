...
namespace Saobracaj.Uvoz
{
    public partial class frmUvozKonacnaZaglavlje : Form
    {
        ...
        {
            var select = " Select UvozKonacnaZaglavlje.ID, UvozKonacnaZaglavlje.IDVoza, Voz.BrVoza, Voz.VremePolaska, Voz.VremeDolaska, s1.Opis as StanicaOd, s2.Opis as StanicaDo, Voz.Relacija Napomena from UvozKonacnaZaglavlje " +
