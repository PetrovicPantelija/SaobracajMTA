...
namespace Saobracaj.Uvoz
{
    ...
    internal class InsertZapisnikOOstecenju
    {
        string connection = Sifarnici.frmLogovanje.connectionString;


        public void InsZapisnikOOStecenju(int NalogID, string Napomena)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "InsertZapisnikOOstecenju";
        ...
        public void DelZapisnikOOstecenju(int NalogID)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "DeleteZapisnikOOstecenju";
            cmd.CommandType = CommandType.StoredProcedure;
