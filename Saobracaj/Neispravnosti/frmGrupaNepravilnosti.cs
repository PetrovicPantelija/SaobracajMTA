...
{
    public partial class frmGrupaNepravilnosti : Syncfusion.Windows.Forms.Office2010Form
    {
        bool status = false;
        string connection = Saobracaj.Sifarnici.frmLogovanje.connectionString;
        public frmGrupaNepravilnosti()
        {
            InitializeComponent();
        }

        private void frmGrupaNepravilnosti_Load(object sender, EventArgs e)
        {
            FillGV();
        }
        private void FillGV()
        {
            var select = "Select * From sifGrupaNepravilnosti order by ID desc";
        ...
        {
            Nepravilnosti.InsertNepravilnosti ins = new InsertNepravilnosti();
            ins.DelSifGrupaNepravilnosti(Convert.ToInt32(txtID.Text));
            FillGV();
        }
