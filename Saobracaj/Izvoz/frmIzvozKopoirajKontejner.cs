...
{
    public partial class frmIzvozKopoirajKontejner : Form
    {
        ...
        public frmIzvozKopoirajKontejner()
        {
            InitializeComponent();
        }

        public frmIzvozKopoirajKontejner(int ID)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i <= Convert.ToInt32(textBox1.Text); i++)
            {
                ...
                InsertIzvoz iu = new InsertIzvoz();
