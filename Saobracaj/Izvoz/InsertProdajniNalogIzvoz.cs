...
namespace Saobracaj.Izvoz
{
    class InsertProdajniNalogIzvoz
    {
        ...
        public int InsProdajniNalogIzvoz(string Korisnik, int Nalogodavac, string OpisPosla, int Brodar, int Izvoznik, string Link, DateTime CuttofPort, string BukingNumber)
        {
            int IDPom = 0;
        ...
        public void UpdProdajniNalogIzvoz(int ID, string Korisnik, int Nalogodavac, string OpisPosla, int Brodar, int Izvoznik, string Link, DateTime CuttofPort, string BukingNumber)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "UpdateProdajniNalogIzvoz";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void UpdProdajniNalogIzvozStavke(int ID, double Kolicina, string JM, int TipKontejnera, int KvalitetKontejnera, string RefZaFakturisanje, string StatusStavke)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "UpdateProdajniNalogIzvozStavke";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DelPorudzbenice(int ID)
        {
            SqlConnection conn = new SqlConnection(connection);
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "DeleteProdajniNalogIzvoz";
            cmd.CommandType = CommandType.StoredProcedure;
