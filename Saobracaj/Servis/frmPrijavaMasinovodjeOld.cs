...
{
    public partial class frmPrijavaMasinovodjeOld : Form
    {
        public frmPrijavaMasinovodjeOld()
        {
            InitializeComponent();
        ...
        {
            var select = "select distinct top 200 Lokomotivaprijava.ID as ID, '' as OznakaPosla, Lokomotivaprijava.Lokomotiva ,(select case when Smer = 1 then 'ODJAVA' else 'PRIJAVA' end) as Smer,Stanice.Opis as Stanica," +
" LokomotivaPrijava.Datum, Rtrim(Delavci.DeIme) + ' ' + Rtrim(Delavci.DePriimek) as Zaposleni," +
" Lokomotivaprijava.MotoSati, Lokomotivaprijava.KM, Lokomotivaprijava.Gorivo, Lokomotivaprijava.Napomena, Lokomotivaprijava.AktivnostID, '' as Posao from LokomotivaPrijava" +
