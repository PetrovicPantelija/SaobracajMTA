...
{
    public partial class InterniPoslovi : Form
    {
        public string connection = Saobracaj.Sifarnici.frmLogovanje.connectionString;

        string Tip = "Interni poslovi";
        int IDInterni;
        string Ulaz;
        string Vrsta;
        string Korisnik = Saobracaj.Sifarnici.frmLogovanje.user;
        public InterniPoslovi(int idInterni, string ulaz, string vrsta)
        {
            InitializeComponent();
            IDInterni = idInterni;
            Ulaz = ulaz;
        ...
        private void InterniPoslovi_Load(object sender, EventArgs e)
        {
            FillCombo();
            InitTable();
            FillMagacinskiBroj();
