...
{
    public partial class InterniPrenos : Form
    {
        public string connection = Saobracaj.Sifarnici.frmLogovanje.connectionString;

        string Tip = "Interni prenos";
        int IDInterni;
        string Ulaz;
        string Vrsta;
        string Korisnik = Saobracaj.Sifarnici.frmLogovanje.user;

        public InterniPrenos(int idInterni,string ulaz,string vrsta)
        {
            InitializeComponent();
            IDInterni=idInterni;
            Ulaz=ulaz;
        ...
        private void InterniPrenos_Load(object sender, EventArgs e)
        {
            FillCombo();
            InitTable();
            FillMagacinskiBroj();
